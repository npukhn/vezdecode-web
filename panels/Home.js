...
const Home = ({ id, go, fetchedUser }) => (
	<Panel id={id}>
			<PanelHeader 
			left={<PanelHeaderButton onClick={go} data-to="start">
       ...
       <FormLayout>
        ...
        <Textarea top="Описание подкаста" placeholder="" />
      </FormLayout>

          <Placeholder
            header="Загрузите Ваш подкаст"
            action={<Button mode="outline" size="l">Загрузить файл</Button>}
          >
       ...
       <Group description="При публикации записи с эпизодом, он становится доступным для всех пользователей">
              <List>
                <Cell description="Всем пользователям" expandable >Кому доступен данный подкаст</Cell>
              </List>
            </Group>
              <Div>
       <Button size="xl" onClick={go} data-to="edit">Далее</Button>
     </Div>
	</Panel>
);
